...
{
    public MeleeAttackState(EnemyMobs enemy, string animationName) : base(enemy, animationName) { }
    ...
    public override void AnimationAttackTrigger()
    {
        ...
        Collider2D[] hitColliders = Physics2D.OverlapCircleAll(enemy.ledgeDetector.position, enemy.stats.meleeDistance, enemy.damageableLayer);
